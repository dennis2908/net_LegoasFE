...
<script>
import { storeDM } from '@/views/../redux/storeKantor'
import FormsConfirm from '@/views/kantor/FormsConfirm'
export default {
	name: 'ModalConfirm',
	...
	methods: {
		async submit() {
			await fetch("http://localhost:8080/api/kantors/"+this.storeDM.state.formData.id, {
				method: "delete",
				headers: {
